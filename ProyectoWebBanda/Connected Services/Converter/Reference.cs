...
namespace ProyectoWebBanda.Converter {
    using System.Data;
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Converter.ConverterSoap")]
    public interface ConverterSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ProyectoWebBanda.Converter.ConvertDataTableColumnResponse ConvertDataTableColumn(ProyectoWebBanda.Converter.ConvertDataTableColumnRequest request);
        
        // CODEGEN: Generando contrato de mensaje, ya que la operación tiene múltiples valores de devolución.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ConvertDataTableColumn", ReplyAction="*")]
        System.Threading.Tasks.Task<ProyectoWebBanda.Converter.ConvertDataTableColumnResponse> ConvertDataTableColumnAsync(ProyectoWebBanda.Converter.ConvertDataTableColumnRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ConverterSoapChannel : ProyectoWebBanda.Converter.ConverterSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConverterSoapClient : System.ServiceModel.ClientBase<ProyectoWebBanda.Converter.ConverterSoap>, ProyectoWebBanda.Converter.ConverterSoap {
        ...
        ProyectoWebBanda.Converter.ConvertDataTableColumnResponse ProyectoWebBanda.Converter.ConverterSoap.ConvertDataTableColumn(ProyectoWebBanda.Converter.ConvertDataTableColumnRequest request) {
        ...
        public void ConvertDataTableColumn(ref System.Data.DataSet ds, int TableIndex, string ColumnName, string FromCurrency, string ToCurrency) {
            ProyectoWebBanda.Converter.ConvertDataTableColumnRequest inValue = new ProyectoWebBanda.Converter.ConvertDataTableColumnRequest();
            inValue.ds = ds;
            inValue.TableIndex = TableIndex;
            inValue.ColumnName = ColumnName;
            inValue.FromCurrency = FromCurrency;
            inValue.ToCurrency = ToCurrency;
            ProyectoWebBanda.Converter.ConvertDataTableColumnResponse retVal = ((ProyectoWebBanda.Converter.ConverterSoap)(this)).ConvertDataTableColumn(inValue);
            ds = retVal.ds;
        }
        
        public System.Threading.Tasks.Task<ProyectoWebBanda.Converter.ConvertDataTableColumnResponse> ConvertDataTableColumnAsync(ProyectoWebBanda.Converter.ConvertDataTableColumnRequest request) {
